...
export default function Messenger() {
    ...
    useEffect(() => {
        socket.current = io("https://socket-v9sv.onrender.com");
    ...
    useEffect(() => {
        const allUsers = async () => {
            try {
                const Users = await axios.get("https://backend-wjln.onrender.com/api/users/all");
    ...
    useEffect(() => {
        const getConversations = async () => {
            try {
                const res = await axios.get("https://backend-wjln.onrender.com/api/conversations/" + user._id);
    ...
    useEffect(() => {
        const getMessages = async () => {
            try {
                const res = await axios.get("https://backend-wjln.onrender.com/api/messages/" + currentChat?._id);
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            const res = await axios.post("https://backend-wjln.onrender.com/api/messages", message);
    ...
    const handleClick = async (u) => {
        ...
        try {
            const res = await axios.post('https://backend-wjln.onrender.com/api/conversations', obj);
    ...
    useEffect(() => {
        ...
        if (newUser !== "") {
            const fetchUser = async () => {
                const res = await axios.get(`https://backend-wjln.onrender.com/api/users?userId=${newUser}`);
