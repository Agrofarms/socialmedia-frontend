...
export default function Post({ post, home }) {
    ...
    useEffect(() => {
        const fetchUser = async () => {
            const res = await axios.get(`https://backend-wjln.onrender.com/api/users?userId=${post.userId}`);
            setUser(res.data);
        }
        fetchUser();
    ...
    const likeHandler = () => {
        ...
        try {
            axios.put("https://backend-wjln.onrender.com/api/posts/" + post._id + "/like", { userId: currentUser._id })
        } catch (err) {
            console.log(err);
        }
    ...
    const deletePost = async () => {
        ...
        try {
            await axios.delete("https://backend-wjln.onrender.com/api/comments/post/" + post._id).then(await axios.delete("https://backend-wjln.onrender.com/api/posts/" + post._id, { data: obj }));
            postDeleted();
            handleClose();
    ...
    const unfollow = async () => {
        try {
            ...
            await axios.put("https://backend-wjln.onrender.com/api/users/" + post.userId + "/unfollow", { userId: currentUser._id })
    ...
    useEffect(() => {
        const fetchComments = async () => {
            const res = await axios.get(`https://backend-wjln.onrender.com/api/comments/${post._id}`)
