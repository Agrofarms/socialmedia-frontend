...
export default function Rightbar({ user }) {
    ...
    useEffect(() => {
        const fetchPosts = async () => {
            const res = user?._id ?
                await axios.get(`https://backend-wjln.onrender.com/api/posts/profile/${user?.username}`)
                : await axios.get(`https://backend-wjln.onrender.com/api/posts/profile/${currentUser.username}`)
    ...
    useEffect(() => {
        const getFriends = async () => {
            try {
                ...
                const friendList = user?._id ? await axios.get("https://backend-wjln.onrender.com/api/users/friends/" + user?._id) : await axios.get("https://backend-wjln.onrender.com/api/users/friends/" + currentUser._id)
    ...
    useEffect(() => {
        const getFollowers = async () => {
            try {
                ...
                const friendList = user?._id ? await axios.get("https://backend-wjln.onrender.com/api/users/followers/" + user?._id) : await axios.get("https://backend-wjln.onrender.com/api/users/followers/" + currentUser._id)
    ...
    const ProfileRightbar = () => {
        ...
        const handleClick = async () => {
            try {
                ...
                if (followed) {
                    await axios.put("https://backend-wjln.onrender.com/api/users/" + user._id + "/unfollow", { userId: currentUser._id })
                    dispatch({ type: "UNFOLLOW", payload: user._id })
                }
                else {
                    await axios.put("https://backend-wjln.onrender.com/api/users/" + user._id + "/follow", { userId: currentUser._id })
